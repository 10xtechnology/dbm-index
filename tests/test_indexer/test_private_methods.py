...
from src.dbm_indexer.helpers import custom_hash
...
class TestIndexerPrivateMethods(TestCase):
    ...
    def test_create_key_index(self):
        ...
        self.assertEqual(indexer.db, {'0#0#value': b'hello', '0#1#value': b'world', '0#1#next': b'0'})
    ...
    def test_create_filter_index(self): # TODO MULTIPLE
        ...
        indexer._create_filter_index(key_hash, value_hash, resource_id_encoded, encoded_value_dump, value)

        self.assertEqual(indexer.db, {'2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824#head': b'"world"', '2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824#toe': b'"world"', '2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824#486ea46224d1bb4fb680f34f7c9ad96a8f24ec88be73ea8e5a6c65260e9cb8a7#0#value': b'0', '2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824#486ea46224d1bb4fb680f34f7c9ad96a8f24ec88be73ea8e5a6c65260e9cb8a7#head': b'0'})
    ...
    def test_create_sort_index(self): # TODO MULTIPLE
        ...
        self.assertEqual(indexer.db, {'2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824#head': b'"world"', '2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824#toe': b'"world"'})
